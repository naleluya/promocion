...
//		wp_enqueue_style( 'colibri-demo-imports',
//			PageBuilder::instance()->assetsRootURL() . "/css/demo-import.css",
//			array(),
//			PageBuilder::instance()->getVersion()
//
//		);
		...
		if ( $this->isImporterInstalled() ) {
			...
			if ( ! isDev() ) {
				...
				wp_enqueue_script( 'colibri-regenerate-theme', builderUrl( "renderer.js", "js" ), array( 'h-vendor' ),
					$ver, true );
			} else {
