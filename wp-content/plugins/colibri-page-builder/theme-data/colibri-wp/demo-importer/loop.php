<?php $demos = \ColibriWP\Theme\View::getData( 'demos' ); ?>
            ...
            <div class="colibri-ocdi-demo-item-content-wrapper">
                ...
                <div class="colibri-ocdi-demo-item-action">
                    ...
                    <div class="colibri-ocdi-demo-item-import">
                        ...
                        <input data-colibri-demo-import-runner="<?php echo esc_attr( $index ); ?>" type="hidden" value="<?php echo esc_attr( $index ); ?>" class="js-ocdi-gl-import-data">
                    </div>
                </div>
            </div>
        </div>
